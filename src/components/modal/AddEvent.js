...
export default function AddEvent({ dateSelected, setShowModal }) {
  ...
  return (
    <div className="flex flex-col justify-center text-left absolute  z-50 backdrop-blur-lg items-center h-full w-full ">
...
<RxCross2 onClick={()=>setShowModal(false)}/>
      ...
      <form onSubmit={handleSubmit} className="max-w-md  bg-white rounded-[10px] w-full">
        <div className='text-[#1D2671] mt-4 font-bold flex justify-center w-full items-center'>
          {dateSelected}
        </div>
